  ...
  export default {
    ...
    methods: {
      ...
      async payOrder() {
        ...
        const {
          data: res
        } = await $http.post('https://api-ugo-web.itheima.net/api/public/v1/my/orders/create', orderInfo)
        ...
        const {
          data: res2
        } = await $http.post('https://api-ugo-web.itheima.net/api/public/v1/my/orders/req_unifiedorder', {
